...
If you run the MATLAB code you will get the following figure: 

![](fig4_regenerated.png)

The MATLAB code re-generates Fig. 4b in the paper which shows a sharp transition from chaos to order. 
